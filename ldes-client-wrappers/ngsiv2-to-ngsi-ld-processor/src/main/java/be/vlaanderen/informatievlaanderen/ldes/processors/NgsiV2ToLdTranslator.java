...
@Tags({ "vsds, ngsiv2-to-ld" })
@CapabilityDescription("Translate and transform NGSIv2 data to NGSI-LD")
public class NgsiV2ToLdTranslator extends AbstractProcessor {

	private static final Logger LOGGER = LoggerFactory.getLogger(NgsiV2ToLdTranslator.class);
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		NgsiV2ToLdTranslator other = (NgsiV2ToLdTranslator) obj;
