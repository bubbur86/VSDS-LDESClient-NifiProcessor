...
import be.vlaanderen.informatievlaanderen.ldes.processors.NgsiV2ToLdTranslator;

@WireMockTest(httpPort = 10101)
class NgsiV2ToLdTranslatorTest {
	...
	@BeforeEach
	void setup() {
		testRunner = TestRunners.newTestRunner(NgsiV2ToLdTranslator.class);
	}
